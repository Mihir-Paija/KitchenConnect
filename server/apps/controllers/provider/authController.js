...
import {providerSignUpJoiValidation, providerLoginJoiValidation} from '../../utils/validations/provider/authValidation.js'
...
export const providerSignUpPost = async (req, res) =>{
	try{
	 ...
	 const {name, email, mobile, password, city, businessName, shortDescription, flatNumber, street, landmark, provideDelivery} = req.body;
