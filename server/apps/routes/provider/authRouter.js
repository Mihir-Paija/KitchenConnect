...
import {providerSignUpGet, providerSignUpPost, providerLoginGet, providerLoginPost, providerLogoutGet, getProfile, setFCMToken, isExpired} from '../../controllers/provider/authController.js'
...
router.route('/:id/expired').get(isExpired)
