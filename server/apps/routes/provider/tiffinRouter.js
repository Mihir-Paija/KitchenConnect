...
import { getLunchTiffins, addTiffins, editTiffin, deleteTiffin, deactivateTiffin, getDinnerTiffins } from "../../controllers/provider/tiffinController.js";
...
router.route('/:id/dinner').get(authMiddleware, getDinnerTiffins)
