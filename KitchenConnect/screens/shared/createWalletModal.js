...
const CreateWalletModal = ({ isVisible, onClose, onCreate, type}) => {
  ...
  const handleCreate = () => {
    ...
    if(!pin1 || !pin2 || !pin3 || !pin4 || !rePin1 ||!rePin2 || !rePin3 || !rePin4){
        Alert.alert('Please Fill All Digits')
        return
    }
    ...
    >
     <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          onChangeText={(text) => handleInputChange(text, 1, setPin1, pin2Ref)}
        />
        <TextInput
          style={styles.pinInput}
          keyboardType="numeric"
          ...
          value={pin2}
          secureTextEntry={true}
          onChangeText={(text) => handleInputChange(text, 2, setPin2, pin3Ref)}
          ref={pin2Ref}
        />
        <TextInput
          style={styles.pinInput}
          ...
          value={pin3}
          secureTextEntry={true}
          onChangeText={(text) => handleInputChange(text, 3, setPin3, pin4Ref)}
          ref={pin3Ref}
        />
        <TextInput
          style={styles.pinInput}
        ...
        />
          ...
          value={rePin1}
          secureTextEntry={true}
          onChangeText={(text) => handleInputChange(text, 1, setRePin1, rePin2Ref)}
        />
        <TextInput
          style={styles.pinInput}
          keyboardType="numeric"
          ...
          value={rePin2}
          secureTextEntry={true}
          onChangeText={(text) => handleInputChange(text, 2, setRePin2, rePin3Ref)}
          ref={rePin2Ref}
        />
        <TextInput
          style={styles.pinInput}
          ...
          value={rePin3}
          secureTextEntry={true}
          onChangeText={(text) => handleInputChange(text, 3, setRePin3, rePin4Ref)}
          ref={rePin3Ref}
        />
        <TextInput
          style={styles.pinInput}
          ...
          value={rePin4}
          secureTextEntry={true}
          onChangeText={(text) => handleInputChange(text, 4, setRePin4, null)}
          ref={rePin4Ref}
        />
          </View>
          <View style={styles.info}>
          <TouchableOpacity onPress={handleCreate} style={styles.submitButton}>
