...
import { updateProfileCustomer } from "../services/customerAPI";
          ...
          <ScrollView>
            <View style={styles.profileImageContainer}>
              <View style={styles.profileBox}>
                <Image
                  source={require("../assets/icons8-user-pastel-glyph/icons8-user-100.png")}
                  style={styles.profileImage}
                />
                <TouchableOpacity style={styles.editIcon}>
                  <Image
                    source={require("../assets/icons8-edit-ios-17-outlined/icons8-edit-100.png")}
