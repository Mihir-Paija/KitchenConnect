...
import HeaderHomeCustomer from "../components/kitchenScreenHeader";
...
const HomeCustomerScreen = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    <KitchenComponent
      ...
      imageSource={require("@/assets/sam-moqadam-Oxpa8sZwGNU-unsplash 1.png")}
  ...
  const Profile = {
    ...
    active: require("@assets/icons8-male-user-ios-17-filled/icons8-male-user-100.png"),
    inactive: require("@assets/icons8-male-user-ios-17-outlined/icons8-male-user-100.png"),
  };
