    ...
    <>
      <View style={styles.header}>
        <View style={styles.locationPickerContainer}>
          <Image
            source={require("@assets/icons8-location-ios-17-filled/icons8-location-100.png")}
        ...
        <TouchableOpacity style={styles.menuItem} onPress={handleProfile}>
          <Image
            source={require("@assets/icons8-male-user-ios-17-filled/icons8-male-user-100.png")}
            style={styles.icon}
          />
        </TouchableOpacity>
      </View>
