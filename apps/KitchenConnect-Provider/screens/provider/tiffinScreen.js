...
import AddTiffinModal1 from './modals/addTiffinModal1';
import AddTiffinModal2 from './modals/addTiffinModal2';
...
/*
  ...
  useEffect(() => {
    ...
    if(!socket || socket.id === undefined || socket.id === null){
      const newSocket = connectSocket(authState.authToken)  
