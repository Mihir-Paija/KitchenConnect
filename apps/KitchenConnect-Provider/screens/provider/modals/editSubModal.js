...
const EditSubModal = ({ isVisible, onClose, onEdit, onDelete, item,tiffin }) => {
    ...
    const [perTiffin, setPerTiffin] = useState(item.priceDetails.price - item.priceDetails.kitchenDiscount)
